...
class HolidayContentTest {
    ...
    void lightsAndStarsExposeTheirUpstreamPhysicalProperties() {
        ...
        assertEquals(15, centerLights.getLightEmission(EmptyBlockGetter.INSTANCE, BlockPos.ZERO));
        assertEquals(15, sideLights.getLightEmission(EmptyBlockGetter.INSTANCE, BlockPos.ZERO));
        ...
        assertEquals(15, BlockRegistry.STAR_OF_BETHLEHEM.get().defaultBlockState()
                .getLightEmission(EmptyBlockGetter.INSTANCE, BlockPos.ZERO));
