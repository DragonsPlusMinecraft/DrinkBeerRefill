...
public enum Goods {
    ...
    //From
    /*----------------------------------------------*/
    NORTHON_AMETHYST_NIGELLA_SEEDS(new Good().set(SPICE_AMETHYST_NIGELLA_SEEDS.get(), NORTHON, FROM, null, 2, 2, NORMAL)),
    NORTHON_ICE_MINT(new Good().set(SPICE_ICE_MINT.get(), NORTHON, FROM, null, 2, 2, NORMAL)),
    NORTHON_ROASTED_RED_PINE_NUTS(new Good().set(SPICE_ROASTED_RED_PINE_NUTS.get(), NORTHON, FROM, null, 2, 2, NORMAL)),
    NORTHON_GLACE_GOJI_BERRIES(new Good().set(SPICE_GLACE_GOJI_BERRIES.get(), NORTHON, FROM, null, 2, 2, NORMAL)),
    ...
    NORTHON_ICE_PATCHOULI(new Good().set(SPICE_ICE_PATCHOULI.get(), NORTHON, FROM, null, 1, 2, RARE)),
    NORTHON_CITRINE_NIGELLA_SEEDS(new Good().set(SPICE_CITRINE_NIGELLA_SEEDS.get(), NORTHON, FROM, null, 1, 2, RARE)),
    NORTHON_FROZEN_PERSIMMON(new Good().set(SPICE_FROZEN_PERSIMMON.get(), NORTHON, FROM, null, 1, 2, RARE)),
    ...
    NORTHON_SILVER_NEEDLE_WHITE_TEA(new Good().set(SPICE_SILVER_NEEDLE_WHITE_TEA.get(), NORTHON, FROM, null, 1, 2, SUPER_RARE)),
    ...
    NORTHON_LAKAS_CALL_BELL(new Good().set(LEKAS_CALL_BELL.get(), NORTHON, FROM, LEKA, 1, 1, UNIQUE)),
    NORTHON_STORM_SHARDS(new Good().set(SPICE_STORM_SHARDS.get(), NORTHON, FROM, null, 2, 3, UNIQUE)),
    ...
    NORTHON_WHITE_WOOL(new Good().set(Items.WOOL.white(), NORTHON, TO, LEKA, 1, 2, NORMAL)),
    ...
    //From
    /*----------------------------------------------*/
    TWIGVALLEY_DRIED_EGLIA_BUD(new Good().set(SPICE_DRIED_EGLIA_BUD.get(), TWIGVALLEY, FROM, null, 2, 2, NORMAL)),
    TWIGVALLEY_SMOKED_EGLIA_BUD(new Good().set(SPICE_SMOKED_EGLIA_BUD.get(), TWIGVALLEY, FROM, null, 2, 2, NORMAL)),
    TWIGVALLEY_GOLDEN_CINNAMON_POWDER(new Good().set(SPICE_GOLDEN_CINNAMON_POWDER.get(), TWIGVALLEY, FROM, null, 2, 2, NORMAL)),
    TWIGVALLEY_ORANGE_WOOL(new Good().set(Items.WOOL.orange(), TWIGVALLEY, FROM, WILL, 2, 3, NORMAL)),
    TWIGVALLEY_ORANGE_TERRACOTTA(new Good().set(Items.DYED_TERRACOTTA.orange(), TWIGVALLEY, FROM, WILL, 2, 3, NORMAL)),
    ...
    TWIGVALLEY_BLAZE_PAPRIKA(new Good().set(SPICE_BLAZE_PAPRIKA.get(), TWIGVALLEY, FROM, null, 1, 2, RARE)),
    ...
    TWIGVALLEY_ROASTED_PECANS(new Good().set(SPICE_ROASTED_PECANS.get(), TWIGVALLEY, FROM, null, 1, 2, RARE)),
    TWIGVALLEY_SWEET_BERRIES(new Good().set(Items.SWEET_BERRIES, TWIGVALLEY, FROM, null, 4, 5, RARE)),
    TWIGVALLEY_DRIED_SELAGINELLA(new Good().set(SPICE_DRIED_SELAGINELLA.get(), TWIGVALLEY, FROM, null, 1, 2, RARE)),
